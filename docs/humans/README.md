...
| --- | --- | ---: | --- |
| `feature/sim-shape/shape` | `crate/sim-shape` | 1 | Define reusable Shape matching, binding, browse-only callable signatures, citizen projection, and grammar contracts for runtime values. |
...
| `feature/sim-shape/relation-shape` | `crate/sim-relation-shape` | 1 | Resolve open relational domains through Cx and project cells, rows, schemas, plans, migrations, bindings, and receipts as native inspectable Shape-bearing records. |
